...
<title>Kelola Donasi | Donasi Transparan</title>
...
<li><a href="<?= base_url('admin/donations') ?>" class="active"><i class="fa-solid fa-hand-holding-heart me-2"></i>Kelola Donasi</a></li>

<li><a href="<?= base_url('admin/reports') ?>"><i class="fa-solid fa-chart-column me-2"></i>Laporan</a></li>
...
<i class="fa-solid fa-wallet fa-3x text-success mb-3"></i>
...
Data donasi akan ditampilkan setelah sistem terhubung dengan database.
